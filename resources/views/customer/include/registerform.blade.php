...
<button type="button" onclick="validateForm()"
    class="bg-yellow-400 hover:bg-yellow-200 hover:text-black text-white border border-yellow-300  font-bold py-2 px-4 rounded-lg transition-colors delay-150">สนใจสิทธิพิเศษ</button>
...
<script>
    ...
    function submitForm(data) {
        ...
        axios.post('{{ route('campaign-register.register') }}', {
                data: data
                // position: position
            })
